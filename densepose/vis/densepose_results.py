...
class DensePoseResultsVisualizer:
    def visualize(
        ...
        import pickle
        data = {"iuv":iuv_array.cpu().numpy(), "boxes":boxes_xywh} 
        with open('/home/ac/data/2023/zhanzechao/ours/detectron2/projects/DensePose/output.pkl', 'wb') as handle:
            pickle.dump(data, handle, protocol=pickle.HIGHEST_PROTOCOL)
        print('exit densepose')
        exit(0)
